...
Google, in their infinite wisdom, has taken down our extensions from the Chrome Webstore for no valid reason. We literally take sh\*t from no one, and we have a back-up solution already in place in case this happened. It's their loss. Stay tuned.
